package chokemonster.bettervanilla.tileentities;
...
public class BetterBlastFurnaceTileEntity extends AbstractFurnaceTileEntity {

    public BetterBlastFurnaceTileEntity() {
        super(MiscInit.BETTERBLASTFURNACETE, IRecipeType.BLASTING);
    }
